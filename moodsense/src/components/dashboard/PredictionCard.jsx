...
export const PredictionCard = () => (
  <DashboardCard className="lg:col-span-5">
    ...
    <div className="grid items-center gap-4 sm:grid-cols-[96px_1fr]">
      ...
      <div>
        <p className="text-slate-400">Likely <span className="font-bold text-white">Happy</span></p>
        <p className="mt-1 text-2xl font-black text-violet-300">82% <span className="text-sm font-medium text-slate-300">Confidence</span></p>
      </div>
    </div>
